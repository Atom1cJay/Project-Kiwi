...
public class DoubleJump : AJump
{
    ...
    public DoubleJump(MovementInputInfo mii, MovementInfo mi, MovementSettingsSO ms, Vector2 horizVector) : base(mii, mi, ms, ms.DjInitVel, ms.DjVelMultiplierAtCancel) { }
